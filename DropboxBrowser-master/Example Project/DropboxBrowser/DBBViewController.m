...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"showDropboxBrowser"]) {
        ...
        dropboxBrowser.bShouldLogout = YES;
    }else if ([[segue identifier] isEqualToString:@"showGoogleDriveBrowser"]){
        UINavigationController *navigationController = [segue destinationViewController];
        
        // Pass any objects to the view controller here, like...
        GoogleDriveViewController *gdViewController = (GoogleDriveViewController *)navigationController.topViewController;
        gdViewController.strFilePath = @"";
        gdViewController.strFolderId = @"root";
    }
}
...
- (IBAction)clearDocs:(id)sender { //OBS
